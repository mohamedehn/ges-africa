...
@Component({
  ...
  template: `
    <section class="hero-gradient pt-32 pb-20 mt-20 min-h-screen flex items-center">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="#contact" class="bg-ges-green text-white px-8 py-4 rounded-lg font-semibold text-center hover:bg-opacity-90 transition">
                Demander une étude
              </a>
          ...
          <div class="hidden md:block">
            <img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80" alt="Panneaux solaires" class="rounded-2xl shadow-2xl">
          </div>
        </div>
      </div>
    </section>
